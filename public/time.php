...
$lideres = [
    ...
    [
        ...
        "bio" => "CEO da LiberaCash, lidera a visão estratégica da empresa e a expansão da plataforma no mercado brasileiro de comparação de crédito.",
    ...
    [
        ...
        "area" => "Tecnologia",
        "bio" => "Responsável pela arquitetura tecnológica, segurança da informação e evolução dos produtos digitais da LiberaCash.",
    ...
    [
        ...
        "area" => "Atendimento",
        "bio" => "Experiência do usuário, atendimento multicanal e satisfação de quem usa a LiberaCash.",
...
})(window,document,'script','dataLayer','GTM-W7PDP2N2');</script>
<!-- End Google Tag Manager -->
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-Q3RMG12R4Y"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'G-Q3RMG12R4Y');
</script>
    <meta charset="UTF-8">
    ...
    <link rel="canonical" href="https://libera.cash/time/">

    <link href="/images/favicon.png" rel="shortcut icon" type="image/x-icon">
    <link href="/images/webclip.png" rel="apple-touch-icon">

    <link href="https://fonts.googleapis.com/css?family=Lato:100,300,400,700,900|Raleway:400,500,600,700,800,900|Montserrat:400,600,700,800&display=swap" rel="stylesheet">
  ...
  <link href="/css/brand-tokens.css?v=<?= @filemtime(__DIR__ . '/css/brand-tokens.css') ?: '1' ?>" rel="stylesheet">
</head>
<body>
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W7PDP2N2"
...
<div class="container">
    ...
    <div class="section-title">
        ...
        <p>Quem está no comando da visão e da tecnologia da LiberaCash</p>
    </div>
    ...
    <div class="section-title">
        ...
        <p>As 8 áreas primordiais que sustentam a operação da LiberaCash</p>
    </div>
