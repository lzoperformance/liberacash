...
<div class="wrap">
    <div class="page-header">
        <h1>Leads <span style="font-weight:400;color:#888;font-size:1rem;">(<?php echo number_format($totalLeads, 0, ',', '.'); ?> encontrados)</span></h1>
        <a class="btn-new" href="/admin_dashboard/leads-export.php?<?php echo htmlspecialchars($qsBase, ENT_QUOTES, 'UTF-8'); ?>"><i class="fas fa-file-excel"></i> Exportar (Excel)</a>
    </div>
    ...
    <div class="card">
        <form method="GET" class="filters">
            ...
            <div class="fgroup" style="flex-grow:1; min-width:200px;">
            ...
            <button type="submit" class="btn-new"><i class="fas fa-filter"></i> Filtrar</button>
            <?php if ($dataInicio || $dataFim || $produtoFiltro || $busca): ?>
                <a class="btn-outline" href="/admin_dashboard/leads.php">Limpar</a>
            <?php endif; ?>
        </form>
    </div>
    ...
    <div class="card">
        <table>
            ...
            <tbody>
                <?php if (empty($leads)): ?>
                    <tr><td colspan="8" class="empty-cell">Nenhum lead encontrado com esses filtros.</td></tr>
                <?php else: foreach ($leads as $l): ?>
                    <tr>
                        <td><strong><?php echo htmlspecialchars($l['nome'], ENT_QUOTES, 'UTF-8'); ?></strong><br><span style="color:#999;font-size:11.5px;">CPF <?php echo htmlspecialchars($l['cpf'], ENT_QUOTES, 'UTF-8'); ?></span></td>
                        <td><?php echo htmlspecialchars($l['email'], ENT_QUOTES, 'UTF-8'); ?><br><span style="color:#999;font-size:11.5px;"><?php echo htmlspecialchars($l['celular'], ENT_QUOTES, 'UTF-8'); ?></span></td>
