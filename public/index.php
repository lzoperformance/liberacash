...
<script>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .slider-btn { background: rgba(0, 0, 0, 0.35); color: white; border: none; width: 34px; height: 34px; border-radius: 50%; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: var(--transition); pointer-events: auto; font-size: 12px; position: relative; }
    ...
    .dot { width: 8px; height: 8px; border-radius: 50%; background: #ddd; cursor: pointer; transition: var(--transition); position: relative; border: none; padding: 0; }
  ...
  <footer class="footer">
    <div class="footer-container">
      <picture>
        <source type="image/avif" srcset="images/logo-480w.avif">
        <source type="image/webp" srcset="images/logo-480w.webp">
        <img src="images/logo-footer.png?v=7" class="footer-logo" alt="LiberaCash" width="480" height="167" loading="lazy" decoding="async">
      </picture>
