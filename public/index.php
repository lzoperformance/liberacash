    ...
    <div class="header-container">
      <div class="logo">
        <picture>
          ...
          <img src="images/logo.png?v=6" alt="LiberaCash" width="480" height="167" decoding="async">
        </picture>
      </div>
      <nav class="nav-menu">
  ...
  <footer class="footer">
    <div class="footer-container">
      <picture>
        <source type="image/avif" srcset="images/logo-480w.avif">
        <source type="image/webp" srcset="images/logo-480w.webp">
        <img src="images/logo-footer.png?v=6" class="footer-logo" alt="LiberaCash" width="480" height="167" loading="lazy" decoding="async">
      </picture>
