...
<footer class="painel-footer">
  <div class="painel-footer__inner">
    <p class="painel-footer__disclaimer">
      Crédito.vc é um site de comparação e correspondente de instituições financeiras parceiras,
    ...
    <p class="painel-footer__copy">&copy; <?php echo date('Y'); ?> Crédito.vc — Todos os direitos reservados.</p>
  </div>
</footer>
